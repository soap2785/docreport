...
async def generateDOCXReport() -> None:
    ...
    if CompiledData.inn and CompiledData.inn not in ('Информация об ИНН не найдена.', '', "Нет доступа к ресурсу"):
