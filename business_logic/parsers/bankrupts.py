...
def bankrupt(inn, surname, name, patronymic) -> str | None:
    driver.get(url)
    inp = wd.until(EC.visibility_of_element_located((By.XPATH, '/html/body/app-root/section/div[1]/app-bankrupt/div/div[1]/div/app-bankrupt-form/div/form/app-form-search-string/div/form/div/div/el-input/div/div/div/input')))
    inp.send_keys(inn, Keys.ENTER)
    try:
        wd.until(EC.visibility_of_element_located((By.XPATH, '/html/body/app-root/section/div[1]/app-bankrupt/div/div[2]/div/app-loader/div[1]/app-bankrupt-result/el-tab-panel/div[2]')))
        ...
        try:
            driver.find_element(By.XPATH,'/html/body/app-root/section/div[1]/app-bankrupt/div/div[2]/div/app-loader/div/div/div[1]')
